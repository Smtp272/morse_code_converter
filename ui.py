...
class MorseCodeConverter:
    def __init__(self):
        ...
        ###BUTTONS
        self.translate_button = Button(self.root, text="Translate !", font=translate_btn, command=self._translate_text)
        self.translate_button.grid(column=1, row=2, padx=20)

        self.clear_button = Button(self.root, text="Clear", command=self._clear_textboxes)
